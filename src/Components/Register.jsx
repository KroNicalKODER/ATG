...
function Register(props) {
    ...
    return (
      <Modal
        ...
        centered
        // centered = {!props.mobile ? true : false}
        // style={{
        //         // position:'absolute',
            ...
            <Container className='' style={{flex:1}}>
                    {
                        ...
                        <Form>
                            <Row className='g-0'>
                                <Col >
                                    <Form.Control style={{borderRadius:'0px', background:'#F7F8FA', border:'1px solid #D9D9DB', fontWeight:'500', fontSize:'0.75rem', color: '#8A8A8A', padding:'0.5rem 0.8rem'}} placeholder='First Name'/>
                                </Col>
                                <Col>
                                    <Form.Control style={{borderRadius:'0px', background:'#F7F8FA', border:'1px solid #D9D9DB', fontWeight:'500', fontSize:'0.75rem', color: '#8A8A8A', padding:'0.5rem 0.8rem'}} placeholder='Last Name'/>
                                </Col>
                            </Row>
                            <Row className='g-0'>
                                <Form.Control style={{borderRadius:'0px', background:'#F7F8FA', border:'1px solid #D9D9DB', fontWeight:'500', fontSize:'0.75rem', color: '#8A8A8A', padding:'0.5rem 0.8rem'}} placeholder='Email'/>
                            </Row>
                            <Row className='g-0'>
                                <Form.Control style={{borderRadius:'0px', background:'#F7F8FA', border:'1px solid #D9D9DB', fontWeight:'500', fontSize:'0.75rem', color: '#8A8A8A', padding:'0.5rem 0.8rem'}} placeholder='Password'/>
                            </Row>
                            <Row className='g-0'>
                                <Form.Control style={{borderRadius:'0px', background:'#F7F8FA', border:'1px solid #D9D9DB', fontWeight:'500', fontSize:'0.75rem', color: '#8A8A8A', padding:'0.5rem 0.8rem'}} placeholder='Confim Password'/>
                            </Row>
                            {
                                props.mobile?
                                <Row className='g-0 my-4 d-flex'>
                                    <Col>
                                        <Button variant='primary' className='rounded-pill'>Create Account</Button>
                                    </Col>
